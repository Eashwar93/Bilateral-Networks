...
from .resnet_fanet18_v3 import Resnet18
...
class FANet18_v3(nn.Module):
    def __init__(self, n_classes=2, backbone='resnet18', aux_output=False):
        super(FANet18_v3, self).__init__()
        ...
        self.aux1 = FPNOutput(64,256, n_classes)
        self.init_weight()
