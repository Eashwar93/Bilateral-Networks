...
class FANet18_v1_se2_c1(nn.Module):
    def __init__(self, n_classes=2, backbone='resnet18', aux_output=False, export=False):
        ...
        self.fam_64 = FastAttModule(in_chan=512, mid_chn=256, out_chan=128, res=(7,10))
    ...
    def forward(self, x, lbl=None):
        ...
        up_feat_64, smfeat_64 = self.fam_64(feat64, None, True, True)
