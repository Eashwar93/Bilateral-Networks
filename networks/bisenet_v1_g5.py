...
from .resnext18_mix import ResneXt18_mix
...
class SpatialPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.conv2 = GConvBNRelu(64, 128, ks=3, stride=2, padding=1)
        self.gather1 = ConvBNRelu(128,64,ks=1,stride=1,padding=0)
        self.conv3 = GConvBNRelu(64, 128, ks=3, stride=2, padding=1)
