...
parse.add_argument('--model', dest='model', type=str, default='fanet18_v4_se1',)
parse.add_argument('--weight-path', dest='weight_pth', type=str, default='./res/fanet18_v4_se1.pth')
parse.add_argument('--outpath', dest='out_pth', type=str, default='./res/fanet18_v4_se1.onnx')
